...
func main() {
	...
	conn, err := sql.Open("pgx", "host=localhost port=5432 dbname=test_connect user=dell password=chilliDog")
	if err != nil {
	...
	// insert a row using $ syntax for injection safety
